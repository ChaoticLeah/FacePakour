...
export function setupTracking() {
  ...
  var processfn = function (video, dt) {
    ...
    var positioning = {
      ...
      leftEye: undefined,
      face: undefined,
      totalWidth: video.getBoundingClientRect().width,
      totalHeight: video.getBoundingClientRect().height,
    };
    ...
    for (let i = 0; i < dets.length; ++i)
      ...
      if (dets[i][3] > 50.0) {
        ...
        //
        //ctx.beginPath();
        positioning.face = { x: dets[i][1], y: dets[i][0], r: dets[i][2] / 2 };
